...
- Source agent: `devops-engineer`
- Upstream file: `.claude/agents/devops-engineer.md`
- Original description: The DevOps Engineer maintains build pipelines, CI/CD configuration, version control workflow, and deployment infrastructure. Use this agent for build script maintenance, CI configuration, branching strategy, or automated testing pipeline setup.
