...
- Source agent: `qa-lead`
- Upstream file: `.claude/agents/qa-lead.md`
- Original description: The QA Lead owns test strategy, bug triage, release quality gates, and testing process design. Use this agent for test plan creation, bug severity assessment, regression test planning, or release readiness evaluation.
