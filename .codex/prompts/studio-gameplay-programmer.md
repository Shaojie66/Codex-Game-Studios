...
- Source agent: `gameplay-programmer`
- Upstream file: `.claude/agents/gameplay-programmer.md`
- Original description: The Gameplay Programmer implements game mechanics, player systems, combat, and interactive features as code. Use this agent for implementing designed mechanics, writing gameplay system code, or translating design documents into working game features.
