...
- Source agent: `unity-addressables-specialist`
- Upstream file: `.claude/agents/unity-addressables-specialist.md`
- Original description: The Addressables specialist owns all Unity asset management: Addressable groups, asset loading/unloading, memory management, content catalogs, remote content delivery, and asset bundle optimization. They ensure fast load times and controlled memory usage.
