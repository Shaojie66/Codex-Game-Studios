...
- Source agent: `analytics-engineer`
- Upstream file: `.claude/agents/analytics-engineer.md`
- Original description: The Analytics Engineer designs telemetry systems, player behavior tracking, A/B test frameworks, and data analysis pipelines. Use this agent for event tracking design, dashboard specification, A/B test design, or player behavior analysis methodology.
