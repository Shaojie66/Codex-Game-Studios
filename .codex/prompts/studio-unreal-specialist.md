...
- Source agent: `unreal-specialist`
- Upstream file: `.claude/agents/unreal-specialist.md`
- Original description: The Unreal Engine Specialist is the authority on all Unreal-specific patterns, APIs, and optimization techniques. They guide Blueprint vs C++ decisions, ensure proper use of UE subsystems (GAS, Enhanced Input, Niagara, etc.), and enforce Unreal best practices across the codebase.
