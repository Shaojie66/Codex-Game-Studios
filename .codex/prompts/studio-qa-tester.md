...
- Source agent: `qa-tester`
- Upstream file: `.claude/agents/qa-tester.md`
- Original description: The QA Tester writes detailed test cases, bug reports, and test checklists. Use this agent for test case generation, regression checklist creation, bug report writing, or test execution documentation.
