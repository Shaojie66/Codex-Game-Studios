...
- Source agent: `godot-shader-specialist`
- Upstream file: `.claude/agents/godot-shader-specialist.md`
- Original description: The Godot Shader specialist owns all Godot rendering customization: Godot shading language, visual shaders, material setup, particle shaders, post-processing, and rendering performance. They ensure visual quality within Godot's rendering pipeline.
