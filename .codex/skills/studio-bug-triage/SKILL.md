...
description: Codex bridge for the legacy Claude Code Game Studios workflow `bug-triage`
---

# Studio Bridge: bug-triage

This wrapper ports the legacy workflow defined in `.claude/skills/bug-triage/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/bug-triage/SKILL.md` in full before taking action.
