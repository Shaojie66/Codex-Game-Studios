...
description: Codex bridge for the legacy Claude Code Game Studios workflow `prototype`
---

# Studio Bridge: prototype

This wrapper ports the legacy workflow defined in `.claude/skills/prototype/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/prototype/SKILL.md` in full before taking action.
