...
description: Codex bridge for the legacy Claude Code Game Studios workflow `patch-notes`
---

# Studio Bridge: patch-notes

This wrapper ports the legacy workflow defined in `.claude/skills/patch-notes/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/patch-notes/SKILL.md` in full before taking action.
