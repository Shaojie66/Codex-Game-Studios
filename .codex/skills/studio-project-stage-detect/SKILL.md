...
description: Codex bridge for the legacy Claude Code Game Studios workflow `project-stage-detect`
---

# Studio Bridge: project-stage-detect

This wrapper ports the legacy workflow defined in `.claude/skills/project-stage-detect/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/project-stage-detect/SKILL.md` in full before taking action.
