...
description: Codex bridge for the legacy Claude Code Game Studios workflow `day-one-patch`
---

# Studio Bridge: day-one-patch

This wrapper ports the legacy workflow defined in `.claude/skills/day-one-patch/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/day-one-patch/SKILL.md` in full before taking action.
