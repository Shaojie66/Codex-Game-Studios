...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-level`
---

# Studio Bridge: team-level

This wrapper ports the legacy workflow defined in `.claude/skills/team-level/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-level/SKILL.md` in full before taking action.
