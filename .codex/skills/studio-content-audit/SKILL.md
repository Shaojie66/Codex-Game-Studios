...
description: Codex bridge for the legacy Claude Code Game Studios workflow `content-audit`
---

# Studio Bridge: content-audit

This wrapper ports the legacy workflow defined in `.claude/skills/content-audit/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/content-audit/SKILL.md` in full before taking action.
