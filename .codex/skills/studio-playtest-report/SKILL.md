...
description: Codex bridge for the legacy Claude Code Game Studios workflow `playtest-report`
---

# Studio Bridge: playtest-report

This wrapper ports the legacy workflow defined in `.claude/skills/playtest-report/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/playtest-report/SKILL.md` in full before taking action.
