...
description: Codex bridge for the legacy Claude Code Game Studios workflow `skill-test`
---

# Studio Bridge: skill-test

This wrapper ports the legacy workflow defined in `.claude/skills/skill-test/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/skill-test/SKILL.md` in full before taking action.
