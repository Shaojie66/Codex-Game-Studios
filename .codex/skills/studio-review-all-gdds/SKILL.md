...
description: Codex bridge for the legacy Claude Code Game Studios workflow `review-all-gdds`
---

# Studio Bridge: review-all-gdds

This wrapper ports the legacy workflow defined in `.claude/skills/review-all-gdds/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/review-all-gdds/SKILL.md` in full before taking action.
