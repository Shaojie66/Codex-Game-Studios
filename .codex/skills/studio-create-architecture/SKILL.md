...
description: Codex bridge for the legacy Claude Code Game Studios workflow `create-architecture`
---

# Studio Bridge: create-architecture

This wrapper ports the legacy workflow defined in `.claude/skills/create-architecture/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/create-architecture/SKILL.md` in full before taking action.
