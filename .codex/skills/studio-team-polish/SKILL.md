...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-polish`
---

# Studio Bridge: team-polish

This wrapper ports the legacy workflow defined in `.claude/skills/team-polish/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-polish/SKILL.md` in full before taking action.
