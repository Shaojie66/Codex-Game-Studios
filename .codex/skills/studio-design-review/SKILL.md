...
description: Codex bridge for the legacy Claude Code Game Studios workflow `design-review`
---

# Studio Bridge: design-review

This wrapper ports the legacy workflow defined in `.claude/skills/design-review/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/design-review/SKILL.md` in full before taking action.
