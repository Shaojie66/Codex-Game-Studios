...
description: Codex bridge for the legacy Claude Code Game Studios workflow `perf-profile`
---

# Studio Bridge: perf-profile

This wrapper ports the legacy workflow defined in `.claude/skills/perf-profile/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/perf-profile/SKILL.md` in full before taking action.
