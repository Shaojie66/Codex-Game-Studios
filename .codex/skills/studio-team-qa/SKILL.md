---
name: studio-team-qa
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-qa`
---

# Studio Bridge: team-qa

This wrapper ports the legacy workflow defined in `.claude/skills/team-qa/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-qa/SKILL.md` in full before taking action.
