...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-audio`
---

# Studio Bridge: team-audio

This wrapper ports the legacy workflow defined in `.claude/skills/team-audio/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-audio/SKILL.md` in full before taking action.
