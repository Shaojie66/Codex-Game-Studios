...
description: Codex bridge for the legacy Claude Code Game Studios workflow `milestone-review`
---

# Studio Bridge: milestone-review

This wrapper ports the legacy workflow defined in `.claude/skills/milestone-review/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/milestone-review/SKILL.md` in full before taking action.
