...
description: Codex bridge for the legacy Claude Code Game Studios workflow `asset-spec`
---

# Studio Bridge: asset-spec

This wrapper ports the legacy workflow defined in `.claude/skills/asset-spec/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/asset-spec/SKILL.md` in full before taking action.
