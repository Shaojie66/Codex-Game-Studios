...
description: Codex bridge for the legacy Claude Code Game Studios workflow `skill-improve`
---

# Studio Bridge: skill-improve

This wrapper ports the legacy workflow defined in `.claude/skills/skill-improve/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/skill-improve/SKILL.md` in full before taking action.
