...
description: Codex bridge for the legacy Claude Code Game Studios workflow `quick-design`
---

# Studio Bridge: quick-design

This wrapper ports the legacy workflow defined in `.claude/skills/quick-design/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/quick-design/SKILL.md` in full before taking action.
