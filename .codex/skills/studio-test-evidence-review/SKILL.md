...
description: Codex bridge for the legacy Claude Code Game Studios workflow `test-evidence-review`
---

# Studio Bridge: test-evidence-review

This wrapper ports the legacy workflow defined in `.claude/skills/test-evidence-review/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/test-evidence-review/SKILL.md` in full before taking action.
