...
description: Codex bridge for the legacy Claude Code Game Studios workflow `propagate-design-change`
---

# Studio Bridge: propagate-design-change

This wrapper ports the legacy workflow defined in `.claude/skills/propagate-design-change/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/propagate-design-change/SKILL.md` in full before taking action.
