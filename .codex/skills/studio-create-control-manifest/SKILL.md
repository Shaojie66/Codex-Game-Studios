...
description: Codex bridge for the legacy Claude Code Game Studios workflow `create-control-manifest`
---

# Studio Bridge: create-control-manifest

This wrapper ports the legacy workflow defined in `.claude/skills/create-control-manifest/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/create-control-manifest/SKILL.md` in full before taking action.
