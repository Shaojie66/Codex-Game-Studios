...
description: Codex bridge for the legacy Claude Code Game Studios workflow `smoke-check`
---

# Studio Bridge: smoke-check

This wrapper ports the legacy workflow defined in `.claude/skills/smoke-check/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/smoke-check/SKILL.md` in full before taking action.
