...
description: Codex bridge for the legacy Claude Code Game Studios workflow `test-helpers`
---

# Studio Bridge: test-helpers

This wrapper ports the legacy workflow defined in `.claude/skills/test-helpers/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/test-helpers/SKILL.md` in full before taking action.
