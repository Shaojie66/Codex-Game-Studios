...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-combat`
---

# Studio Bridge: team-combat

This wrapper ports the legacy workflow defined in `.claude/skills/team-combat/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-combat/SKILL.md` in full before taking action.
