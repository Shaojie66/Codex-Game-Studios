...
description: Codex bridge for the legacy Claude Code Game Studios workflow `sprint-status`
---

# Studio Bridge: sprint-status

This wrapper ports the legacy workflow defined in `.claude/skills/sprint-status/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/sprint-status/SKILL.md` in full before taking action.
