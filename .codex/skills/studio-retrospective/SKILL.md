...
description: Codex bridge for the legacy Claude Code Game Studios workflow `retrospective`
---

# Studio Bridge: retrospective

This wrapper ports the legacy workflow defined in `.claude/skills/retrospective/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/retrospective/SKILL.md` in full before taking action.
