---
name: studio-hotfix
description: Codex bridge for the legacy Claude Code Game Studios workflow `hotfix`
---

# Studio Bridge: hotfix

This wrapper ports the legacy workflow defined in `.claude/skills/hotfix/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/hotfix/SKILL.md` in full before taking action.
