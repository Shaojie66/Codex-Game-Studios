...
description: Codex bridge for the legacy Claude Code Game Studios workflow `estimate`
---

# Studio Bridge: estimate

This wrapper ports the legacy workflow defined in `.claude/skills/estimate/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/estimate/SKILL.md` in full before taking action.
