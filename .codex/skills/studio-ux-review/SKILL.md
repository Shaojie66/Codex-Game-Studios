...
description: Codex bridge for the legacy Claude Code Game Studios workflow `ux-review`
---

# Studio Bridge: ux-review

This wrapper ports the legacy workflow defined in `.claude/skills/ux-review/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/ux-review/SKILL.md` in full before taking action.
