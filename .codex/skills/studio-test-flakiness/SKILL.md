...
description: Codex bridge for the legacy Claude Code Game Studios workflow `test-flakiness`
---

# Studio Bridge: test-flakiness

This wrapper ports the legacy workflow defined in `.claude/skills/test-flakiness/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/test-flakiness/SKILL.md` in full before taking action.
