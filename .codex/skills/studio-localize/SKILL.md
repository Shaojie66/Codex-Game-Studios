...
description: Codex bridge for the legacy Claude Code Game Studios workflow `localize`
---

# Studio Bridge: localize

This wrapper ports the legacy workflow defined in `.claude/skills/localize/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/localize/SKILL.md` in full before taking action.
