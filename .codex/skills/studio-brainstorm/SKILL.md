...
description: Codex bridge for the legacy Claude Code Game Studios workflow `brainstorm`
---

# Studio Bridge: brainstorm

This wrapper ports the legacy workflow defined in `.claude/skills/brainstorm/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/brainstorm/SKILL.md` in full before taking action.
