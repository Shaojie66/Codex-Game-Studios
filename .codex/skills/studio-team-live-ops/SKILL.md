...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-live-ops`
---

# Studio Bridge: team-live-ops

This wrapper ports the legacy workflow defined in `.claude/skills/team-live-ops/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-live-ops/SKILL.md` in full before taking action.
