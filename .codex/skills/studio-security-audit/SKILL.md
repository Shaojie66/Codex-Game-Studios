...
description: Codex bridge for the legacy Claude Code Game Studios workflow `security-audit`
---

# Studio Bridge: security-audit

This wrapper ports the legacy workflow defined in `.claude/skills/security-audit/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/security-audit/SKILL.md` in full before taking action.
