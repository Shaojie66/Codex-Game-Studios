...
description: Codex bridge for the legacy Claude Code Game Studios workflow `tech-debt`
---

# Studio Bridge: tech-debt

This wrapper ports the legacy workflow defined in `.claude/skills/tech-debt/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/tech-debt/SKILL.md` in full before taking action.
