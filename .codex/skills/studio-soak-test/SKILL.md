...
description: Codex bridge for the legacy Claude Code Game Studios workflow `soak-test`
---

# Studio Bridge: soak-test

This wrapper ports the legacy workflow defined in `.claude/skills/soak-test/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/soak-test/SKILL.md` in full before taking action.
