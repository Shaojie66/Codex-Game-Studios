...
description: Codex bridge for the legacy Claude Code Game Studios workflow `changelog`
---

# Studio Bridge: changelog

This wrapper ports the legacy workflow defined in `.claude/skills/changelog/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/changelog/SKILL.md` in full before taking action.
