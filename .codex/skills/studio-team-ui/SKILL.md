---
name: studio-team-ui
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-ui`
---

# Studio Bridge: team-ui

This wrapper ports the legacy workflow defined in `.claude/skills/team-ui/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-ui/SKILL.md` in full before taking action.
