...
description: Codex bridge for the legacy Claude Code Game Studios workflow `gate-check`
---

# Studio Bridge: gate-check

This wrapper ports the legacy workflow defined in `.claude/skills/gate-check/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/gate-check/SKILL.md` in full before taking action.
