---
name: studio-help
description: Codex bridge for the legacy Claude Code Game Studios workflow `help`
---

# Studio Bridge: help

This wrapper ports the legacy workflow defined in `.claude/skills/help/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/help/SKILL.md` in full before taking action.
