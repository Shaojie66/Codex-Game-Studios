...
description: Codex bridge for the legacy Claude Code Game Studios workflow `architecture-decision`
---

# Studio Bridge: architecture-decision

This wrapper ports the legacy workflow defined in `.claude/skills/architecture-decision/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/architecture-decision/SKILL.md` in full before taking action.
