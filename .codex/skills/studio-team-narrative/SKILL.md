...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-narrative`
---

# Studio Bridge: team-narrative

This wrapper ports the legacy workflow defined in `.claude/skills/team-narrative/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-narrative/SKILL.md` in full before taking action.
