...
description: Codex bridge for the legacy Claude Code Game Studios workflow `team-release`
---

# Studio Bridge: team-release

This wrapper ports the legacy workflow defined in `.claude/skills/team-release/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/team-release/SKILL.md` in full before taking action.
