...
description: Codex bridge for the legacy Claude Code Game Studios workflow `reverse-document`
---

# Studio Bridge: reverse-document

This wrapper ports the legacy workflow defined in `.claude/skills/reverse-document/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/reverse-document/SKILL.md` in full before taking action.
