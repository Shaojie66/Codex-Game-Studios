...
description: Codex bridge for the legacy Claude Code Game Studios workflow `sprint-plan`
---

# Studio Bridge: sprint-plan

This wrapper ports the legacy workflow defined in `.claude/skills/sprint-plan/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/sprint-plan/SKILL.md` in full before taking action.
