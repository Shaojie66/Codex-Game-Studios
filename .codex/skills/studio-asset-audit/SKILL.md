...
description: Codex bridge for the legacy Claude Code Game Studios workflow `asset-audit`
---

# Studio Bridge: asset-audit

This wrapper ports the legacy workflow defined in `.claude/skills/asset-audit/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/asset-audit/SKILL.md` in full before taking action.
