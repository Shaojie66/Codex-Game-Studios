...
description: Codex bridge for the legacy Claude Code Game Studios workflow `create-stories`
---

# Studio Bridge: create-stories

This wrapper ports the legacy workflow defined in `.claude/skills/create-stories/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/create-stories/SKILL.md` in full before taking action.
