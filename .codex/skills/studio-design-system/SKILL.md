...
description: Codex bridge for the legacy Claude Code Game Studios workflow `design-system`
---

# Studio Bridge: design-system

This wrapper ports the legacy workflow defined in `.claude/skills/design-system/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/design-system/SKILL.md` in full before taking action.
