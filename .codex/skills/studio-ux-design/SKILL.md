...
description: Codex bridge for the legacy Claude Code Game Studios workflow `ux-design`
---

# Studio Bridge: ux-design

This wrapper ports the legacy workflow defined in `.claude/skills/ux-design/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/ux-design/SKILL.md` in full before taking action.
