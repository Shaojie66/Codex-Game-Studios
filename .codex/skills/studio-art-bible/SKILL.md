...
description: Codex bridge for the legacy Claude Code Game Studios workflow `art-bible`
---

# Studio Bridge: art-bible

This wrapper ports the legacy workflow defined in `.claude/skills/art-bible/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/art-bible/SKILL.md` in full before taking action.
