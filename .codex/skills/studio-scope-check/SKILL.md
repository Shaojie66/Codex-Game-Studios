...
description: Codex bridge for the legacy Claude Code Game Studios workflow `scope-check`
---

# Studio Bridge: scope-check

This wrapper ports the legacy workflow defined in `.claude/skills/scope-check/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/scope-check/SKILL.md` in full before taking action.
