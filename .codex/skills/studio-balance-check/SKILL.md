...
description: Codex bridge for the legacy Claude Code Game Studios workflow `balance-check`
---

# Studio Bridge: balance-check

This wrapper ports the legacy workflow defined in `.claude/skills/balance-check/SKILL.md` to Codex/OMX.

<Execution>
1. Read `.claude/skills/balance-check/SKILL.md` in full before taking action.
